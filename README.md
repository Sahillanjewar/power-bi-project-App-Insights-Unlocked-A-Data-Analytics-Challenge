...
•	Conducted a data analytics project on Google Play Store apps to uncover insights related to ratings, installs, categories, pricing, and user behavior.Built interactive dashboards in Power BI to analyze app performance and user engagement patterns.
